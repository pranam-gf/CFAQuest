...
const DeepSeekLogo: React.FC<LogoProps> = ({ className, ...props }) => (
  <img 
...
const MistralLogo: React.FC<LogoProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
    <g transform="scale(0.094)">
      ...
      <path d="M0 0h46.545v46.545H0zm0 46.545h46.545V93.09H0zm0 46.546h46.545v46.545H0zm0 46.545h46.545v46.545H0z"/>
...
const KimiLogo: React.FC<LogoProps> = (props) => (
...
const QwenLogo: React.FC<LogoProps> = (props) => (
  <svg fill="currentColor" fillRule="evenodd" height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const MetaLogo: React.FC<LogoProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
    ...
    <g transform="translate(12, 12) scale(0.094) translate(-128, -85.5)">
...
export const getProviderInfo = (model: string): { name: string; color: string; logo: React.FC<LogoProps> | React.ReactElement } => {
  ...
  if (model.includes('gpt') || model.includes('o1') || model.includes('o3') || model.includes('o4') || model.includes('openai') || model.includes('oss')) {
  ...
  if (model.includes('groq') && !model.includes('llama') && !model.includes('qwen')) {
    return {
      name: 'Groq',
      color: '#FFA500',
      logo: GroqLogo
  ...
  if (model.includes('kimi') || model.includes('moonshot')) {
    return { name: 'Moonshot AI', color: '#6366F1', logo: KimiLogo };
  }
  
  if (model.includes('qwen')) {
    return { name: 'Alibaba', color: '#FF6A00', logo: QwenLogo };
  }
