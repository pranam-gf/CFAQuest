...
const DeepSeekLogo: React.FC<LogoProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 3L19 7V17L12 21L5 17V7L12 3Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
...
const WriterLogo: React.FC<LogoProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M3 17.25V21H6.75L17.81 9.94L14.06 6.19L3 17.25Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <path d="M20.71 7.04C21.1 6.65 21.1 6.02 20.71 5.63L18.37 3.29C17.98 2.9 17.35 2.9 16.96 3.29L15.13 5.12L18.88 8.87L20.71 7.04Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
  </svg>
);
...
const XAILogo: React.FC<LogoProps> = (props) => (
  <img 
    src="/svgs/xai.svg" 
    alt="xAI" 
    width="22" 
