...
export default function GitHubEssayButton() {
  const handleClick = () => {
    window.open('https://github.com/pranam-gf/CFA_ESSAY_REPRODUCER', '_blank');
  };
  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <span className="ml-2 text-black dark:text-white">Essay Repo</span>
      </div>
    </Button>
  );
}