...
export function OverviewMetrics() {
  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[...Array(4)].map((_, i) => (
          <div key={i}>
            <div className="h-24 bg-transparent rounded-xl"></div>
          </div>
        ))}
      </div>
    );
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-4">
          <h3 className="text-lg text-gray-900 dark:text-white mb-1">Total Models</h3>
          <p className="text-xs text-gray-600 dark:text-gray-400">Active in evaluation</p>
        </div>
        <div>
          <div className="text-4xl font-normal text-blue-600 dark:text-blue-400 mb-2">
            {stats.totalModels}
          </div>
      ...
      >
        <div className="mb-4">
          <h3 className="text-lg text-gray-900 dark:text-white mb-1">Best MCQ Accuracy</h3>
      ...
      >
        <div className="mb-4">
          <h3 className="text-lg text-gray-900 dark:text-white mb-1">Best Essay Score</h3>
      ...
      >
        <div className="mb-4">
          <h3 className="text-lg text-gray-900 dark:text-white mb-1">Most Cost Efficient</h3>
