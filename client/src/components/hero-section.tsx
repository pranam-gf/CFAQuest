...
const NavLink = ({ viewType, children, icon }: NavLinkProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`flex items-center gap-3 backdrop-blur-md rounded-2xl px-6 py-3 border shadow-lg transition-all duration-200 min-w-fit whitespace-nowrap ${
        isActive
...
export function HeroSection() {
  return (
    <div className="relative">
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-48 pb-0">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 dark:text-white leading-tight mb-8 px-4">
                <span className="whitespace-nowrap">Benchmarking AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-[#464348] to-indigo-600 dark:from-blue-400 dark:via-[#464348] dark:to-indigo-400">in Finance</span></span>
              </h1>
